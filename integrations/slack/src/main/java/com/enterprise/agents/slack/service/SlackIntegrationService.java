...
@Service
public class SlackIntegrationService extends BaseIntegrationService {
    ...
    protected String exchangeCodeForToken(IntegrationConfiguration config, String code) {
        ...
        params.add("redirect_uri", baseRedirectUri + "/api/slack/oauth/callback");
        ...
        if (response == null || response.get("access_token") == null) {
            throw new RuntimeException("Failed to exchange code for Slack token");
        }
